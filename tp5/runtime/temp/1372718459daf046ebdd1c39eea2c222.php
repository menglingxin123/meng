<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:66:"F:\wamp\www\tp5\public/../application/admin\view\auth_rule\add.htm";i:1513826929;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\head.htm";i:1514082882;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\left.htm";i:1514095268;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                                        ...
                                        <form class="form-horizontal" role="form" action="" method="post">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="pid" style="width: 100%;">
                                                        <option selected="selected" value="0">顶级规则</option>
                                                         ...
                                                         <option value="<?php echo $auth['id']; ?>"><?php echo str_repeat('-',$auth['level']*6)?><?php echo $auth['title']; ?></option>
                                                          <?php endforeach; endif; else: echo "" ;endif; ?>           
                                                    </select>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio" style="float:left; padding-left:10px;">
                                                        <label>
                                                            <input checked="checked" name="status" value="1" class="colored-blue" type="radio">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio" style="float:left; padding-left:10px;">
                                                        <label>
                                                            <input checked="checked" name="show" value="1" class="colored-blue" type="radio">
                                                            <span class="text">是</span>
                                                        </label>
                                                    </div>
                                                     <!-- 单选按钮 -->
                                                    <div class="radio" style="float:left; padding-left:10px;">
                                                        <label>
                                                            <input name="show" value="0" class="colored-blue" type="radio">
                                                            <span class="text">否</span>
                                                        </label>
                                                    </div>
                                                                                        </div>
