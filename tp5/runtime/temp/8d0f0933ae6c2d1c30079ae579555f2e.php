<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:41:"../template/..\template\default\index.htm";i:1514819145;s:28:"../template/default\head.htm";i:1514688485;s:30:"../template/default\footer.htm";i:1514819269;}*/ ?>
<!DOCTYPE html>
<head id="Head">
...
<link id="_Portals__default_Skins_Biotechnology_Html_css_jquery_fancybox_1_3_4_css?ver=1_0" rel="stylesheet" type="text/css" href="./css/jquery.fancybox-1.3.4.css"/>
...
<?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
  <li <?php if($cate['id'] == $topcid): ?> class="current" <?php endif; ?> >
    ...
    <?php if($cate['cate_attr'] == 1): ?><?php echo url('Cate/index',array('cid'=>$cate['id'])); endif; if($cate['cate_attr'] == 2): ?><?php echo url('Page/index',array('cid'=>$cate['id'])); endif; if($cate['cate_attr'] == 3): ?><?php echo $cate['link']; endif; ?>
    "><strong><?php echo $cate['cate_name']; ?></strong></a><i></i>
      <?php if($cate['children']): ?>
        ...
        <li><a href="
          <?php if($sonCate['cate_attr'] == 1): ?><?php echo url('Cate/index',array('cid'=>$sonCate['id'])); endif; if($sonCate['cate_attr'] == 2): ?><?php echo url('Page/index',array('cid'=>$sonCate['id'])); endif; if($sonCate['cate_attr'] == 3): ?><?php echo $sonCate['link']; endif; ?>
...
<li><a href="/a/guanyuwomen/shengchanjidi/"><span>生产基地</span></a></li>
<li><a href="/a/guanyuwomen/zizhirongyu/"><span>资质荣誉</span></a></li>
</ul><li><a href="javascript:;"><span>新闻动态</span><i class="touch-arrow-down"></i></a>
<ul>
<li><a href="/a/xinwendongtai/gongsixinwen/"><span>公司新闻</span></a></li>
<li><a href="/a/xinwendongtai/xingyedongtai/"><span>行业动态</span></a></li>
</ul><li><a href="javascript:;"><span>产品中心</span><i class="touch-arrow-down"></i></a>
<ul>
<li><a href="/a/chanpinzhongxin/chanpinfenleiyi/"><span>产品分类一</span></a></li>
<li><a href="/a/chanpinzhongxin/chanpinfenleier/"><span>产品分类二</span></a></li>
</ul><li><a href="javascript:;"><span>贸易与合作</span><i class="touch-arrow-down"></i></a>
<ul>
<li><a href="/a/maoyiyuhezuo/guojimaoyi/"><span>国际贸易</span></a></li>
<li><a href="/a/maoyiyuhezuo/guojiquyujingxiao/"><span>国际区域经销</span></a></li>
<li><a href="/a/maoyiyuhezuo/guonaquyudaili/"><span>国内区域代理</span></a></li>
</ul><li><a href="javascript:;"><span>技术服务</span><i class="touch-arrow-down"></i></a>
<ul>
<li><a href="/a/jishufuwu/yanjiuchengguo/"><span>研究成果</span></a></li>
</ul>
...
<?php if(is_array($proRes) || $proRes instanceof \think\Collection || $proRes instanceof \think\Paginator): $i = 0; $__LIST__ = $proRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$pro): $mod = ($i % 2 );++$i;?>
<li>
<div class="scrollable-item">
<p class="scrollable-img"><a target="_blank" href="<?php echo url('Article/index',array('aid'=>$pro['id'])); ?>"><img src="__INDEX__/uploads/img/<?php echo $pro['litpic']; ?>" alt="<?php echo $pro['title']; ?>"/></a></p>
<h2><a target="_blank" href="<?php echo url('Article/index',array('aid'=>$pro['id'])); ?>"><?php echo $pro['title']; ?></a></h2>
</div>
</li>
<?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
                  ...
                  <div class="col-3-1">
                    <div id="a1portalSkin_ctr8921489214_Column3C33A34A33_QHDCPM89214M1" class="qhd_column_contain"><!-- Start_Module_89215 --><a name="31464" id="31464"></a>
                      <div class="module">
                            ...
                            <!-- S entry-item -->
                              <div class="entry-item">
                                ...
                                <div class="entry-title">
                                  <h2><a href="/a/xinwendongtai/gongsixinwen/20160823/21.html" target="_blank"><?php echo $news['title']; ?></a></h2>
                                </div>
                                <div class="entry-summary">
                                  <div class="qhd-content">
                                    <p><?php echo cut_str($news['description'],66); ?></p>
                                  </div>
                                </div>
                              </div>
                              <!-- E entry-item -->
                        ...
                        <div class="module-more-down"><a href="<?php echo url('Cate/index',array('cid'=>7)); ?>" target="_blank">更多</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div id="a1portalSkin_ctr8921489214_Column3C33A34A33_QHDCPM89214M2" class="qhd_column_contain"><!-- Start_Module_89216 --><a name="31465" id="31465"></a>
                      <div class="module">
                        <div class="module-inner">
                          ...
                          <div class="module-more-down"><a href="<?php echo url('Page/index',array('cid'=>2)); ?>" target="_blank">更多</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div id="a1portalSkin_ctr8921489214_Column3C33A34A33_QHDCPM89214M3" class="qhd_column_contain"><!-- Start_Module_89217 --><a name="31466" id="31466"></a>
                      <div class="module">
                        <div class="module-inner">
                          ...
                          <div class="module-more-down"><a href="<?php echo url('Page/index',array('cid'=>11)); ?>" target="_blank">更多</a></div>
                        </div>
                      </div>
                    </div>
                  </div>
