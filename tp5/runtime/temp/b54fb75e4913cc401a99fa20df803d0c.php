<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"F:\wamp\www\tp5\public/../application/admin\view\auth_rule\edit.htm";i:1513848968;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\head.htm";i:1514082882;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\left.htm";i:1514095268;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="/tp5dm/public/admin/auth_rule/lst.html">规则管理</a>
                    </li>
                                    ...
                                    <div id="horizontal-form">
                                        <form class="form-horizontal" action="" method="post">
                                            ...
                                            <div class="form-group">
                                                <label for="group_id" class="col-sm-2 control-label no-padding-right">上级规则</label>
                                                <div class="col-sm-6">
                                                    <select name="pid" style="width: 100%;">
                                                        ...
                                                        <option value="<?php echo $auth['id']; ?>" <?php if($auth['id'] == $authrule['pid']): ?> selected="selected" <?php endif; ?> ><?php echo str_repeat('-',$auth['level']*6)?><?php echo $auth['title']; ?></option>
                                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                            </div> 
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control"  name="title" value="<?php echo $authrule['title']; ?>"  type="text">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input class="form-control"  name="name" value="<?php echo $authrule['name']; ?>"  type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio" style="float:left; padding-left:10px;">
                                                        <label>
                                                            <input <?php if($authrule['status'] == 1): ?> checked="checked" <?php endif; ?> name="status" value="1" class="colored-blue" type="radio">
                                                    ...
                                                    <div class="radio" style="float:left; padding-left:10px;">
                                                        <label>
                                                            <input <?php if($authrule['status'] == 0): ?> checked="checked" <?php endif; ?>name="status" value="0" class="colored-blue" type="radio">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="radio" style="float:left; padding-left:10px;">
                                                        <label>
                                                            <input <?php if($authrule['show'] == 1): ?> checked="checked" <?php endif; ?>name="show" value="1" class="colored-blue" type="radio">
                                                            <span class="text">是</span>
                                                        </label>
                                                    </div>
                                                     <!-- 单选按钮 -->
                                                    <div class="radio" style="float:left; padding-left:10px;">
                                                        <label>
                                                            <input <?php if($authrule['show'] == 0): ?> checked="checked" <?php endif; ?>name="show" value="0" class="colored-blue" type="radio">
                                                            <span class="text">否</span>
                                                        </label>
                                                    </div>
                                                                                        </div>
