<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:60:"F:\wamp\www\tp5\public/../application/admin\view\ad\list.htm";i:1513655188;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\head.htm";i:1514082882;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\left.htm";i:1514095268;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <tbody>
                            <?php if(is_array($adlst) || $adlst instanceof \think\Collection || $adlst instanceof \think\Paginator): $i = 0; $__LIST__ = $adlst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$lst): $mod = ($i % 2 );++$i;?>
                             <tr>
                                ...
                                <td align="center"><?php echo $lst['ad_name']; ?></td>
                                <td align="center"><?php echo $lst['name']; ?></td>
                                <td align="center">
                                    <label>
                                        <input id="<?php echo $lst['id']; ?>" adposid="<?php echo $lst['adpos_id']; ?>"  <?php if($lst['on'] == 1): ?>checked="checked"<?php endif; ?> class="checkbox-slider colored-darkorange" type="checkbox" onclick="changeStatus(this)">
                                ...
                                <td align="center">
                                    ...
                                    <a href="#" onclick="warning('确实要删除吗', '<?php echo url('del',array('id'=>$lst['id'])); ?>')" class="btn btn-danger btn-sm shiny">
