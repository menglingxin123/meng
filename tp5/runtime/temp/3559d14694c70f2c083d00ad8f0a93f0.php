<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:32:"../template/default/list_img.htm";i:1514714949;s:28:"../template/default\head.htm";i:1514688485;s:32:"../template/default\position.htm";i:1514712243;s:28:"../template/default\left.htm";i:1514645120;s:30:"../template/default\footer.htm";i:1503926123;}*/ ?>
<!DOCTYPE html>
<head id="Head">
...
<form name="Form" method="post" action="/about_02/language_zh-CN" id="Form" enctype="multipart/form-data" style="height:inherit">
<div>
<input type="hidden" name="__VIEWSTATE_CACHEKEY" id="__VIEWSTATE_CACHEKEY" value="VS_cmupymwokbk5pe10i0531qoz_/about_02/language_zh-CN"/>
</div>
...
<div id="a1portalSkin_mainArea" class="content-wrapper"> <a name="31457" id="31457"></a>
<div class="module-default">
<div class="module-inner">
<div id="a1portalSkin_ctr8922189221_mainArea" class="module-content">  
...
<div class="portfolio-img"><a href="__INDEX__/uploads/img/<?php echo $art['litpic']; ?>" rel="imgZoom-group-89221" title="<?php echo $art['title']; ?>"><img src="__INDEX__/uploads/img/<?php echo $art['litpic']; ?>" alt="<?php echo $art['title']; ?>"/><span class="opacity-overlay"><i class="icon-zoom"></i></span></a></div>
<div class="portfolio-title">
<h2><a href="<?php echo $temp_src; ?>/img/1-160R32336070-L.jpg" rel="imgZoom-group-title-89221" title="<?php echo $art['title']; ?>"><?php echo $art['title']; ?></a></h2>
</div>
</li>
<?php endforeach; endif; else: echo "" ;endif; ?>
...
<script type="text/javascript">
  $(document).ready(function(){
   //弹窗
   $('a[rel=imgZoom-group-89221],a[rel=imgZoom-group-title-89221]').fancybox({
