<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"F:\wamp\www\tp5\public/../application/admin\view\cate\edit.htm";i:1514641137;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\head.htm";i:1514082882;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\left.htm";i:1514095268;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                            ...
                            <div class="widget-main ">
                                <div class="tabbable">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <select name="model_id">
                                                        ...
                                                        <option value="<?php echo $modelinfo['id']; ?>" <?php if($modelinfo['id'] == $cates['model_id']): ?> selected="selected" <?php endif; ?>><?php echo $modelinfo['model_name']; ?></option>
                                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                                    </select>
                                                </div>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                   <select name="pid">
                                                        ...
                                                        <option value="<?php echo $cate['id']; ?>" <?php if($cates['pid'] == $cate['id']): ?> selected="selected" <?php endif; ?>>
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input value="<?php echo $cates['cate_name']; ?>" class="form-control" id="username"  name="cate_name"  type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input class="form-control" <?php if($cates['jump_id'] == 0): ?> value="0" <?php else: ?> value="<?php echo $cates['jump_id']; ?>" <?php endif; ?>  placeholder="" name="jump_id" required="" type="text">
                                        </div>
                                    </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <label>
                                                        <input class="checkbox-slider toggle colored-blue" <?php if($cates['status'] == 0): ?> checked="checked" <?php endif; ?> type="checkbox" name="status" value="0">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-sm-6">
                                                    ...
                                                    <label>
                                                     ...
                                                     <?php if($cates['img']):?>
                                                     <label id="editimg">
                                                       <img style="height:30px;" src="__ADMIN__/uploads/cateimg/<?php echo $cates['img']; ?>"/>
                                                    </label>
                                                    <?php endif;?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                   <div class="radio" style="float:left; padding-left:10px;">
                                                    <label>
                                                        <input name="cate_attr" value="1" type="radio" <?php if($cates['cate_attr'] == 1): ?>checked="checked"<?php endif; ?> >
                                                        <span class="text">列表页栏目（可以发布文章） </span>
                                                    </label>
                                                   </div>
                                                   <div class="radio" style="float:left; padding-left:10px; " >
                                                    <label>
                                                        <input name="cate_attr" type="radio" value="2" <?php if($cates['cate_attr'] == 2): ?>checked="checked"<?php endif; ?>>
                                                        <span class="text">封面频道栏目 </span>
                                                    </label>
                                                   </div>
                                                   <div class="radio" style="float:left; padding-left:10px;">
                                                    <label>
                                                        <input name="cate_attr" type="radio" value="3"  <?php if($cates['cate_attr'] == 3): ?>checked="checked"<?php endif; ?>>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input value="<?php echo $cates['list_tmp']; ?>" class="form-control" id="username"  name="list_tmp" type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input value="<?php echo $cates['index_tmp']; ?>" class="form-control" id="username"  name="index_tmp" type="text">
                                                </div>
                                                <p class="help-block col-sm-4 red">* 必填</p>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input  value="<?php echo $cates['article_tmp']; ?>" class="form-control" id="username"  name="article_tmp" type="text">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input value="<?php echo $cates['link']; ?>"  class="form-control" id="username" name="link" type="text">
                                        ...
                                        <div id="profile11" class="tab-pane">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input  class="form-control" value="<?php echo $cates['title']; ?>" id="username"  name="title" type="text">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <input value="<?php echo $cates['keywords']; ?>" class="form-control" id="username"  name="keywords" type="text">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <textarea class="form-control" value="<?php echo $cates['desc']; ?>" rows="3" placeholder="Content" name="desc"></textarea>
