<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"F:\wamp\www\tp5\public/../application/admin\view\content\edit.htm";i:1512744590;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\head.htm";i:1514082882;s:64:"F:\wamp\www\tp5\public/../application/admin\view\common\left.htm";i:1514095268;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  name="title"  type="text" value="<?php echo $arts['title']; ?>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="checkbox" style="float:left; padding-left:10px;">
                                                    <label>
                                                        <input name="attr[]" class="colored-blue" value="头条" <?php if(in_array('头条',$attr)){echo "checked='checked'";} ?> type="checkbox">
                                                ...
                                                <div class="checkbox" style="float:left; padding-left:10px;">
                                                    <label>
                                                        <input name="attr[]" class="colored-blue" value="推荐"<?php if(in_array('推荐',$attr)){echo "checked='checked'";} ?>  type="checkbox">
                                                ...
                                                <div class="checkbox" style="float:left; padding-left:10px;">
                                                    <label>
                                                        <input name="attr[]" class="colored-blue" value="幻灯"<?php if(in_array('幻灯',$attr)){echo "checked='checked'";} ?>  type="checkbox">
                                                ...
                                                <div class="checkbox" style="float:left; padding-left:10px;">
                                                    <label>
                                                        <input name="attr[]" class="colored-blue" value="加粗"<?php if(in_array('加粗',$attr)){echo "checked='checked'";} ?>  type="checkbox">
                                                ...
                                                <div class="checkbox" style="float:left; padding-left:10px;">
                                                    <label>
                                                        <input name="attr[]" class="colored-blue" value="图片"<?php if(in_array('图片',$attr)){echo "checked='checked'";} ?>  type="checkbox">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                    <?php if(is_array($cateRes) || $cateRes instanceof \think\Collection || $cateRes instanceof \think\Paginator): $i = 0; $__LIST__ = $cateRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;if($cate['id'] == $arts['cate_id']): ?> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  name="keywords" value="<?php echo $arts['keywords']; ?>"  type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <textarea name="description"  class="form-control"><?php echo $arts['description']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  name="writer" value="<?php echo $arts['writer']; ?>"  type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control"  name="source" value="<?php echo $arts['source']; ?>" type="text">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <label>
                                                    ...
                                                    <input name="litpic" value="<?php echo $arts['litpic']; ?>" type="hidden">
                                                </label>
                                                <label>
                                        ...
                                        <div class="form-group" id="imgdiv" <?php if($arts['litpic'] == ''): ?> style="display:none;" <?php endif; ?>>
                                            <label for="username" class="col-sm-2 control-label no-padding-right"></label>
                                            <div class="col-sm-6">
                                                <label id="litpic">
                                                <?php if($arts['litpic'] != ''): ?> 
                                               <img src="__INDEX__/uploads/img/<?php echo $arts['litpic']; ?>" height="100">
                                               <?php endif; ?>
                                                </label>
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <?php switch ($v['field_type']) {
                                                        ...
                                                        case 7:
                                                        case 8:
                                                        echo "<input type='text' value='".$diyvals[$v['field_ename']]."' name='".$v['field_ename']."' class='form-control'>";
                                                        break;
                                                        case 6:
                                                         echo "<input type='file' value='".$diyvals[$v['field_ename']]."' name='".$v['field_ename']."' >";
                                                        if($diyvals[$v['field_ename']]){
                                                            echo "<img src='__INDEX__/uploads/img/".$diyvals[$v['field_ename']]."' height='60'> 
                                                        ...
                                                        case 2:
                                                            if($v['field_values']){
                                                                ...
                                                                if($diyvals[$v['field_ename']]==$v1){
                                                                    ...
                                                                    echo "<label>";
                                                                    echo "<input type='radio' ".$check." name='".$v['field_ename']."' value='".$v1."' class='colored-blue'>";
                                                             ...
                                                             if($v['field_values']){
                                                                ...
                                                                foreach ($arr as $k1 => $v1) {
                                                                 ...
                                                                 echo "<div class='checkbox' style='float:left; padding-left:10px;'>";
                                                                    echo "<label>";
                                                                    echo "<input ".$check." type='checkbox' name='".$v['field_ename']."[]' value='".$v1."' class='colored-blue'>";
                                                                    echo "<span class='text'>$v1</span> ";
                                                                    echo "</label>  ";
                                                                    echo "</div>";
                                                                }
                                       ...
                                       <?php endforeach;?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                               <input class="form-control"  name="click" value="<?php echo $arts['click']; ?>" type="text">
                                            </div>
                                        </div>  
                                        <div class="form-group">
                                        ...
                                        <input type="hidden" name="art_id" value="<?php echo $arts['id']; ?>">
                                        <input type="hidden" name="model_id" value="<?php echo $arts['model_id']; ?>">
...
<script type="text/javascript">
    ...
    UE.getEditor('content',{initialFrameWidth:800,initialFrameHeight:400,});
       ...
       function delimg(o){
        ...
        var aid=<?php echo $arts['id']; ?>;
        var model_id=<?php echo $arts['model_id']; ?>;
        $.ajax({
            type:"post",
            dataType:"json",
            data:{'aid':aid,'model_id':model_id,'field_name':field_name},
            url:"<?php echo url('Content/ajaxDelImg'); ?>",
            success:function(data){
                if(data==1){
                    layer.msg('撤销成功！', {icon: 1});
                }else{
