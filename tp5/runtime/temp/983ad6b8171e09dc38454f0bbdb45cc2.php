<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"../template/default/article_article.htm";i:1514717786;s:28:"../template/default\head.htm";i:1514688485;s:32:"../template/default\position.htm";i:1514712243;s:30:"../template/default\footer.htm";i:1503926123;}*/ ?>
<!DOCTYPE html>
<head id="Head">
...
<meta name="keywords" content="童老师ThinkPHP交流群：333632569"/>
<meta name="description" content="童老师ThinkPHP交流群：333632569"/>
...
<ul>
<li class="touch-toggle-item-first"><a href="javascript:;" class="drawer-language" data-drawer="drawer-section-language">
...
<h2><?php echo $curCates['cate_name']; ?></h2>
</div>
 </section>
...
<div class="entry-meta"><span><strong>所属分类：</strong><a href="
    <?php if($curCates['cate_attr'] == 1): ?><?php echo url('Cate/index',array('cid'=>$curCates['id'])); endif; if($curCates['cate_attr'] == 2): ?><?php echo url('Page/index',array('cid'=>$curCates['id'])); endif; if($curCates['cate_attr'] == 3): ?><?php echo $curCates['link']; endif; ?>
    "><?php echo $curCates['cate_name']; ?></a></span><span><strong>发布时间：</strong><strong><?php echo date("Y-m-d",$arts['time']); ?></strong></span><span><strong></strong></span></div>
<div class="article-content-wrapper">
<div class="article-content">
<div class="qhd-content"><?php echo $arts['content']; ?></div>
</div>
</div>
</div>
  </div>
